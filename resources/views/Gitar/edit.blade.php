...
@section('content')
<h2>Tambah Data</h2>
        <form action="/gitar/{{$gitar->id}}" method="post">
         {{-- validation --}}
   @if ($errors->any())
...
@endif
        ...
        @method('put')
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="merek_gitar" value="{{$gitar->merek_gitar}}" id="merek_gitar" placeholder="Masukkan merek_gitar">
           </div>
           <div class="form-group">
